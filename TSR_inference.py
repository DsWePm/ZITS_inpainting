...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_url', type=str, default=None, help='the txt file of image')
    parser.add_argument('--mask_url', type=str, default=None, help='the folder of mask')
